...
public class Login extends JFrame {
	...
	/**
	 * serialVersionUID es utilizado para controlar la versión de la clase serializada.
	 */
	...
	public Login() {
		...
		// Etiqueta para la imagen del hotel
		...
		// Etiqueta "X" para el botón de cerrar
		...
		// Etiqueta en el botón de inicio de sesión
		...
		// Icono del logo en la esquina superior izquierda
		...
		// Encabezado de la ventana para arrastrar la ventana
	...
	// Métodos para permitir el arrastre de la ventana
